...
function contarDecisionSegunRango($decision,$fechaInicial,$fechaFinal) //dado un id de usuario, me devuelve el id del folder de inicio de ese usuario
{
	...
	if(strcmp($decision, "Improcedente")==0)
	{
	...
	if(strcmp($decision, "No sanciona")==0)
	{
	...
	if(strcmp($decision, "Sin lugar a la apertura del procedimiento")==0)
	{
	...
	if(strcmp($decision, "Sobreseimiento")==0)
	{
	...
	if(strcmp($decision, "Inadmisible")==0)
	{
	...
	if(strcmp($decision, "Desistimiento")==0)
	{
...
if($view) 
{
	...
	$view->setParam('fechaInicial', $fechaInicial);
	$view->setParam('fechaFinal', $fechaFinal);
