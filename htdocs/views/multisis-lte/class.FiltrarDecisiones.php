...
class SeedDMS_View_FiltrarDecisiones extends SeedDMS_Bootstrap_Style 
{
 /**
 ...
 **/
 ...
 $this->startBoxPrimary("Estadísticas de resoluciones según decisión del TEG. Por favor, ingrese un rango de fechas para conocer las decisiones en ese periodo");
...
//////INICIO MI CODIGO
 ...
 <?php $creationdate=FALSE ?>
    <form name="filtroDecisiones" id="filtroDecisiones" action="/out/out.EstadisticasDecisiones.php" method="POST">
