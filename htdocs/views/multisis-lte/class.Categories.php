...
<form class="form-horizontal">
	<div class="control-group">
		 <div class="alert alert-success alert-dismissible">
                ...
                <h4><i class="icon fa fa-sticky-note"></i> Este es el gestor de tipologías de resoluciones</h4>
               
			   En esta pantalla puede renombrar o añadir categorías de resoluciones nuevas:
			   </br>
			   (1)Para añadir una nueva tipología, despliegue la lista siguiente y haga click en "Añadir tipología nueva"-
			   </br>
              (2) Para editar una tipología, seleccione la que le interesa de la lista y cambie el nombre en la caja de texto en la cual aparecerá.
