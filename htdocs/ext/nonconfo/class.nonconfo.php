 ...
 * @subpackage  example
 */
class SeedDMS_ExtNonConfo extends SeedDMS_ExtBase {
	 ...
	 */
	function init() { /* {{{ */
		$GLOBALS['SEEDDMS_HOOKS']['view']['addDocument'][] = new SeedDMS_ExtNonConfo_AddDocument;
		$GLOBALS['SEEDDMS_HOOKS']['view']['viewFolder'][] = new SeedDMS_ExtNonConfo_ViewFolder;
	} /* }}} */
 ...
 * @subpackage  example
 */
class SeedDMS_ExtNonConfo_AddDocument {
 ...
 * @subpackage  example
 */
class SeedDMS_ExtNonConfo_ViewFolder {
